<template>
  <div class="bio-column" data-aos="fade-right" data-aos-offset="300" data-aos-easing="ease-in-sine" data-aos-duration="1000">
    ...
    <div class="ks-bio__chapter">
      <p class="ks-bio__text">
        Во временя учёбы на специалитете меня пригласили работать на киностудию. Долго это не продлилось, так как выше каскадёра
        пробиться не удалось, но опыт, полученный за те годы — бесценный. Я работал с профессионалами своего дела, участвовал в
        сложнейшем процессе организации огромного количества людей: съёмке кино.
      </p>
    </div>
  </div>
